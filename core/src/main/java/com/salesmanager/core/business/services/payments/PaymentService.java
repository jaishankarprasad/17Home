...
public interface PaymentService {
	...
	Transaction createTransactionObject(BigDecimal amount, Order order, Map<String, String> transactionCompleteData,
			PaymentType paymentType) throws ServiceException;
