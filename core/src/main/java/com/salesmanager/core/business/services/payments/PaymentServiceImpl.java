...
public class PaymentServiceImpl implements PaymentService {
	...
	@Override
	public Transaction createTransactionObject(BigDecimal amount,Order order,Map<String,String> transactionCompleteData,PaymentType paymentType) throws ServiceException{
		Transaction transaction = new Transaction();
		transaction.setAmount(amount);
		transaction.setTransactionDate(new Date());
		transaction.setTransactionType(TransactionType.AUTHORIZE);
		...
		//transaction.setPaymentType(PaymentType.CCAvenue);
		transaction.setTransactionDetails(transactionCompleteData);	
