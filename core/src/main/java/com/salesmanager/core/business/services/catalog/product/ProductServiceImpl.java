...
public class ProductServiceImpl extends SalesManagerEntityServiceImpl<Long, Product> implements ProductService {
	...
	@Override
	public List<BigInteger> getMaxPriceProductsByLimitingTo(String categoryCode,Long limit) {
		return productRepository.getMaxPriceProductsByLimitingTo(categoryCode,limit);
	}
	...
	@Override
	public List<BigInteger> getProductIdByCategoryId(List<Long> categoryIds){
		return productRepository.getProductIdByCategoryId(categoryIds);
    }
