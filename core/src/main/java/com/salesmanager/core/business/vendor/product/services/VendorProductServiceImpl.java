...
public class VendorProductServiceImpl extends SalesManagerEntityServiceImpl<Long, VendorProduct> implements  VendorProductService {
	...
	//Find Vendor Based on The ProductId
	@Override
	public List<VendorProduct> findVendorByProductId(Long productId) {
		return vendorProductRepository.findVendorByProductId(productId);
	}
	...
	@Override
	public List<VendorProduct> getVendorAddedProductsByVendorId(Long vendorId) {
		return vendorProductRepository.findVendorAddedProductsByVendorId(vendorId);
	}

	@Override
	public List<VendorProduct> getVendorApprovedProductsByVendorId(Long vendorId) {
		return vendorProductRepository.getVendorApprovedProductsByVendorId(vendorId);
	}

	@Override
	public List<VendorProduct> getByProductIdAndVendorId(Long productId,Long vendorId) {
		return vendorProductRepository.getByProductIdAndVendorId(productId,vendorId);
	}

	@Override
	public List<VendorProduct> getVendoProductsProductIdAndVendorId(Long longProductId, Long longVendorId) {
		return vendorProductRepository.findVendoProductsByProductIdAndVendorId(longProductId,longVendorId);
	}

	@Override
	public List<Customer> searchRequestedVendorsByName(String searchString) {
		// TODO Auto-generated method stub
		return vendorProductRepository.searchRequestedVendorsByName(searchString);
	}

	@Override
	public List<Customer> searchRequestedVendorsById(Long vendorId) {
		// TODO Auto-generated method stub
		return vendorProductRepository.searchRequestedVendorsById(vendorId);
	}
