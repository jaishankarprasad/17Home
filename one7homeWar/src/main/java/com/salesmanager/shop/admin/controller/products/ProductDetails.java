...
public class ProductDetails {
	...
	List<ProductDetails> recomendedProductList;
	...
	public List<ProductDetails> getRecomendedProductList() {
		return recomendedProductList;
	}
	public void setRecomendedProductList(List<ProductDetails> recomendedProductList) {
		this.recomendedProductList = recomendedProductList;
	}
	public List<ProductDetails> getRelatedProductList() {
		return relatedProductList;
	}
	public void setRelatedProductList(List<ProductDetails> relatedProductList) {
