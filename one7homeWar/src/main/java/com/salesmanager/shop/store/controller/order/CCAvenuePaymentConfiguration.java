...
public class CCAvenuePaymentConfiguration {
	...
	@Value("${ccav_payment_gateway_url}")	
	private String ccAvenuePaymentGatewayURL;

	public String getCcAvenuePaymentGatewayURL() {
		return ccAvenuePaymentGatewayURL;
	}

	public void setCcAvenuePaymentGatewayURL(String ccAvenuePaymentGatewayURL) {
		this.ccAvenuePaymentGatewayURL = ccAvenuePaymentGatewayURL;
	}
