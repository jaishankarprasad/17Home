...
*/				
			...
			modelOrder.setPaymentType(order.getPaymentType());
	...
	private void orderCustomer(ShopOrder shopOrder,Customer customer, Order order, Language language) throws Exception {
		...
		if(shopOrder.getPreferedShippingAddress() == 1 && customer.getDelivery() != null){
			order.setDelivery(customer.getDelivery());
		}else if(shopOrder.getPreferedShippingAddress() == 2 && customer.getSecondaryDelivery() != null){
